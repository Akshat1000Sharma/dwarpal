...
import { PageHeader, BackendDown, Card, Cell, Empty, Json, Meter, Pill, Row, Table } from "@/components/ui";
...
export default async function MandatesPage() {
  ...
  return (
    <>
      <PageHeader
        title="Mandates"
        description="The standing authorities currently in force: what each permits, how much of it has been consumed, and when it expires. Revoking one takes effect at its next use."
      />

    <Card
      title="Open mandates in force"
      description="Revoking one stops it at its next use; a revocation that lands after capture is compensated automatically."
    >
      {mandates.length === 0 ? (
